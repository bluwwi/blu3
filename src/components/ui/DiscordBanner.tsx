...
export function DiscordBanner({ title, description, image, url }: DiscordBannerProps) {
  const domain = new URL(url).hostname;

  return (
    <div className="w-[360px] bg-[#2b2d31] rounded-lg overflow-hidden border-l-4 border-[#5865F2]">
